...
/**
 * A class to generate and evaluate a OneRule classifier and store both model and evaluation metrics.  <br>
 *
 * This class reads an '.arff' and uses it to build a OneRule classifier.
