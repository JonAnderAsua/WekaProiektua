 ...
 *
 * This class reads a '.arff' file with two attributes (A message and the class) and turns the text into a vector that is compatible with a dictionary given by the user.<br>
 * <br>
